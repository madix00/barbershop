    ...
    <div className="bg-white dark:bg-gray-900">
      ...
      <div className="relative">
            ...
            <div className="relative px-6 py-32 sm:py-40 lg:px-8 lg:py-56 lg:pr-0">
              <div className="mx-auto max-w-2xl lg:mx-0 lg:max-w-xl">
                ...
                <h1 className="text-5xl font-semibold tracking-tight text-pretty text-gray-900 sm:text-7xl dark:text-white">
                  Din barbershop i Jönköping
                </h1>
                <p className="mt-8 text-lg font-medium text-pretty text-gray-500 sm:text-xl/8 dark:text-gray-400">
                  Slå dig ner i en av våra sköna barberarstolar, drick en god kopp kaffe medan våra erfarna barberare ser till att du blir snygg i både hår och skägg. Välkommen!
                </p>
                <div className="mt-10 flex items-center gap-x-14">
                  <a
                ...
                <div className="mt-10 flex items-center gap-x-2.5">
                  <div
                    className="rounded-md px-3.5 py-3.5 text-lg border-2 font-semibold text-white shadow-xs focus-visible:outline-2 focus-visible:outline-offset-2  bg-zinc-900"
                  >
                     ⭐ 4.8 
                  </div>
        ...
        <div className="bg-gray-50 lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2 dark:bg-gray-800">
          <img
            alt=""
            src="https://wwd.com/wp-content/uploads/2018/01/main-picture.jpg?w=2048"
